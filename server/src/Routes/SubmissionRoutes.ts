...
import { submitUserCode,allSubmission,allPoints,checkSubmit,submission,heatMap,activeDays,checkStreak,checkLanguage,getSolution,analyzeComplexityOfCode,analyzeSpaceComplexityOfCode} from "../Controllers/SubmissionController";
...
submitCodeRoutes.post('/analyzeComplexityOfCode',verifyToken,verifyStudent,analyzeComplexityOfCode);
submitCodeRoutes.post('/analyzeSpaceComplexityOfCode',verifyToken,verifyStudent,analyzeSpaceComplexityOfCode);
